...
{
	/// <summary>
	/// This is a simple general matrix class for fundamental operations of 
	/// numerical linear algebra.
	/// </summary>
	/// <remarks>
	/// The GeneralMatrix class provides the fundamental operations 
	/// of numerical linear algebra. 
	/// Various constructors create matrices from two dimensional arrays of 
	/// double precision floating point numbers. Various properties provide access 
	/// to submatrices and matrix elements. Several methods implement basic matrix 
	/// arithmetic, including matrix addition and multiplication, matrix norms, 
	/// and element-by-element array operations.
	/// <para>
	/// All the operations in this version of the GeneralMatrix Class involve 
	/// real matrices, complex number matrices are not supported.
	/// </para>
	/// Two fundamental matrix decompositions, which consist of pairs or triples
	/// of matrices, permutation vectors, and the like, produce results in five
	/// decomposition classes.  These decompositions are accessed by the GeneralMatrix
	/// class to compute solutions of simultaneous linear equations, determinants,
	/// inverses and other matrix functions.  The two decompositions are:
	/// <list type="number">
	/// <item>
	/// <description>
	...
	/// </remarks>
	[Serializable]
	public class GeneralMatrix : System.ICloneable
	{
		...
		/// <value>Pointer to the two-dimensional array of matrix elements.</value>
		public double[][] Array
		{			
			get
			{
		...
		/// <value> Two-dimensional array copy of matrix elements.</value>
		...
		/// </exception>
		public GeneralMatrix GetMatrix(int i0, int i1, int j0, int j1)
		{
		...
		/// <returns>     A + B
		/// </returns>
		public GeneralMatrix AddEquals(GeneralMatrix B)
		{
			CheckMatrixDimensions(B);
			for (int i = 0; i < m; i++)
			{
		...
		/// <returns>     A - B
		/// </returns>
		public GeneralMatrix SubtractEquals(GeneralMatrix B)
		{
			CheckMatrixDimensions(B);
			for (int i = 0; i < m; i++)
			{
		...
		/// <returns>     A.*B
		/// </returns>
		public GeneralMatrix ArrayMultiplyEquals(GeneralMatrix B)
		{
			CheckMatrixDimensions(B);
			for (int i = 0; i < m; i++)
			{
		...
		/// <returns>     A./B
		/// </returns>
		public GeneralMatrix ArrayRightDivideEquals(GeneralMatrix B)
		{
			CheckMatrixDimensions(B);
			for (int i = 0; i < m; i++)
			{
		...
		/// <returns>     A.\B
		/// </returns>
		public GeneralMatrix ArrayLeftDivideEquals(GeneralMatrix B)
		{
			CheckMatrixDimensions(B);
			for (int i = 0; i < m; i++)
			{
		...
		/// </returns>
		public GeneralMatrix MultiplyEquals(double s)
		{
			for (int i = 0; i < m; i++)
			{
				for (int j = 0; j < n; j++)
