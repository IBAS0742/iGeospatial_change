...
namespace GdalUtilsOz.Utils
{
        ...
        //{
        //        public static double[] getTransform(string geoTransform)
        //        {
        //                double[] transform = new double[6];
        //                int count = 0;
        //                geoTransform.Split(' ').ToList().ForEach(tr => {
        ...
        public class Setting
        {
                ...
                public double[] Transform { get; set; } = new double[6]{38,0.00833333,0,42,0,-0.00833333};
                #endregion
