...
namespace iGeospatial.Texts
{
	...
	public abstract class Token
	{
		...
		/// </summary>
		public int LineNumber { get { return(m_nLineNumber); }}
		...
		{ 
			return(String.Format("{0}: line {1}", ToDebugString(), m_nLineNumber));
		}
		...
		{ 
			return(String.Format("{0}: line {1}", ToString(), m_nLineNumber));
		}
