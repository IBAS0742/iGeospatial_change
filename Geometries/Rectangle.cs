...
namespace iGeospatial.Geometries
{
    ...
    public class Rectangle : Surface
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Rectangle"/> geometry.
        /// </summary>
        /// <param name="factory">
        /// The <see cref="GeometryFactory">geometry factory</see>, which 
        /// created this geometry instance.
        /// </param>
        public Rectangle(GeometryFactory factory) : base(factory) 
        {
        ...
        public Rectangle(Envelope envelope, GeometryFactory factory) 
            : base(factory) 
        {
            m_objCoordinates   = new CoordinateCollection();
        ...
        public Rectangle(ICoordinateList coordinates, GeometryFactory factory) 
            : base(factory)
        {
            if (coordinates == null)
            {
        ...
        public override Geometry Clone()
        {
            if (!IsEmpty)
            {
                ...
                return new Rectangle(coordinates, this.Factory);
            }

            return new Rectangle(this.Factory);
        }
