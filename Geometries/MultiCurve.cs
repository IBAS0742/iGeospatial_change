...
{
	/// <summary>
	/// Summary description for MultiCurve.
	/// </summary>
    [Serializable]
    public class MultiCurve : GeometryCollection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiCurve"/> geometry.
        /// </summary>
        /// <param name="factory">
        /// The <see cref="GeometryFactory">geometry factory</see>, which 
        /// created this geometry instance.
        /// </param>
        public MultiCurve(GeometryFactory factory) : base(factory)
        {
        }
		
        public MultiCurve(Curve[] ellipses, GeometryFactory factory)
        ...
        new public Curve this[int index] 
        {
            get 
            {
                return (Curve)base[index];
            }
