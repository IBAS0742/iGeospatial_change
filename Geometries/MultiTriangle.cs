...
{
	/// <summary>
	/// Summary description for MultiTriangle.
	/// </summary>
    [Serializable]
    public class MultiTriangle : MultiSurface
    {
        /// <summary>
        ...
        new public Triangle this[int index] 
        {
            get 
            {
                return (Triangle)base[index];
            }
        ...
        public override GeometryType GeometryType
        {
            get 
            {
                return GeometryType.MultiTriangle;
            }
        }
