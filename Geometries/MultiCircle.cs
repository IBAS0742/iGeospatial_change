...
{
	/// <summary>
	/// Summary description for MultiCircle.
	/// </summary>
	[Serializable]
    public class MultiCircle : MultiSurface
	{
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiCircle"/> geometry.
        /// </summary>
        /// <param name="factory">
        /// The <see cref="GeometryFactory">geometry factory</see>, which 
        /// created this geometry instance.
        /// </param>
        public MultiCircle(GeometryFactory factory) : base(factory)
        {
        }
		
        public MultiCircle(Circle[] circles, GeometryFactory factory)
            : base(circles, factory)
        {
        }
